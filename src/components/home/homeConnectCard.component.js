function HomeConnectCard(props)
{
	...
	return (
		<div className="grid place-items-center mx-2 rounded-3xl bg-white mx-auto py-8 h-56">
			...
			<p className="font-medium py-4 font-light text-center text-spotify_text_color">Please sign in with your Spotify account to view your stats</p>
